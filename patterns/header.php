...
<div class="wp-block-group has-pale-blue-background-color has-background" style="border-bottom-width:2px"><!-- wp:columns -->
...
<div class="wp-block-group"><!-- wp:search {"label":"Search","showLabel":false,"buttonText":"Search","buttonPosition":"button-only","buttonUseIcon":true,"search_dialog":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|black"}}},"color":{"background":"#ffffff00"},"layout":{"selfStretch":"fit","flexSize":null}},"textColor":"black"} /-->
